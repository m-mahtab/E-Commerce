  ...
  return (
    <Container>
        ...
        <Wrapper>
            ...
            <PUlList>
                <PListItems><PaymentImage src = 'assets/images/visa.png'/></PListItems>
                <PListItems><PaymentImage src = 'assets/images/credit-card1.png'/></PListItems>
                <PListItems><PaymentImage src = 'assets/images/master-card.png'/></PListItems>
                <PListItems><PaymentImage src = 'assets/images/cash-on-delivery.png'/></PListItems>
